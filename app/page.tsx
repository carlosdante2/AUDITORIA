...
// Icono de marca de WhatsApp (lucide ya no incluye logos de marca).
          ...
          <div className="mx-auto mt-12 grid max-w-3xl grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div className="rounded-2xl border border-black/5 bg-[#F4F6F3] p-6">
              ...
              <ul className="mt-4 space-y-3">
                <li>
                  <a
                    href="https://wa.me/573202508852"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Escribir por WhatsApp al +57 320 250 8852"
                ...
                <li>
                  <a
                    href="https://wa.me/573160404533"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Escribir por WhatsApp al +57 316 040 4533"
                    className="flex items-center gap-3 text-[#26332C] transition-colors hover:text-[#2FA26F]"
                  >
                    <WhatsAppIcon className="h-5 w-5 shrink-0 text-[#25D366]" />
              ...
              <ul className="mt-4 space-y-3">
                <li>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Escribir por WhatsApp al +51 906 959 989"
                    className="flex items-center gap-3 text-[#26332C] transition-colors hover:text-[#2FA26F]"
                  >
                    <WhatsAppIcon className="h-5 w-5 shrink-0 text-[#25D366]" />
